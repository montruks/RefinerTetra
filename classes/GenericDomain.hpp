...
namespace GeDiM
{
	...
	class GenericDomain /*Classe generale*/
	{
		protected:
		...
		public:
			GenericDomain(const unsigned int& _globalId); /*costruttore base*/
			GenericDomain(const unsigned int& _globalId, const unsigned int& _totalNumberVertices); /*Costruttore con id e numero di vertici*/
			GenericDomain(const unsigned int& _globalId, const unsigned int& _totalNumberVertices, const unsigned int& _totalNumberEdges); /*Costruttore con id, # vertici, # lati*/
			GenericDomain(const unsigned int& _globalId, const unsigned int& _totalNumberVertices, const unsigned int& _totalNumberEdges, const unsigned int& _totalNumberFaces);/*Costruttore con id, # vertici, # lati, #facce*/
			GenericDomain(const GenericDomain& domain); /*Costruttore di copia*/
			virtual ~GenericDomain(); /*Distruttore*/

			const unsigned int& GlobalId() const { return globalId; } /*Restituisce indirizzo di memoria*/
			...
			const Vector3d& Vertex(const unsigned int& i) const { return vertices[i]; } /*restituisce i-esimo veritice*/
            ///Azioni su Lati
    ...
    ///Figlia classe GenericDomain
	class GenericDomain0D: public GenericDomain, public IRotation
	{
		public:
            ///Costruttori e Costruttori di copia
	...
	class GenericDomain2D : public GenericDomain, public IRotation
	{
		...
		public:
			GenericDomain2D(const unsigned int& _globalId); /*Costruttore*/
			GenericDomain2D(const unsigned int& _globalId, const unsigned int& _totalNumberVertices); /*Costruttore*/
			GenericDomain2D(const GenericDomain2D& domain);
			virtual ~GenericDomain2D(); /*Distruttore*/
